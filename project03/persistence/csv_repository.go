...
[1] The Go Authors. (n.d.). Package csv. pkg.go.dev.
    [Online]. Available at https://pkg.go.dev/encoding/csv [Accessed on: June 15, 2026].
...
[4] Google. (n.d.). Package uuid. pkg.go.dev.
    [Online]. Available at https://pkg.go.dev/github.com/google/uuid [Accessed on: June 15, 2026].
